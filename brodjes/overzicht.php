...
<nav class="navbar navbar-expand-md navbar-light bg-faded">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="overzicht.php">Menu</a>
            </li>
            <li class="nav-item">
...
<div class="container">
    <?php if (isset($_SESSION["user"])) { ?>
        <div class="row">
            <h1>Sandwich list <?php print $usr; ?></h1>
        </div>
        <ul class="list-group">
            <?php
            $list = $tab->getList();
    ...
    <?php } else { ?>
        <div class="row">
            <h3> You mut have an account or crete one</h3>
