...
CKEDITOR.dialog.add("button", function(b) {
    function d(a) {
        ...
        "name" == this.id && (a.attributes["data-cke-saved-name"] = b)) : (delete a.attributes[this.id],
    ...
    return {
        ...
        onOk: function() {
            ...
            d ? a.insertElement(c) : (c.replace(b),
        ...
        contents: [{
            ...
            elements: [{
                ...
                "default": "call",
                accessKey: "T",
                items: [[b.lang.forms.button.typeBtn, "call"], [b.lang.forms.button.typeSbm, "chat"], [b.lang.forms.button.typeRst, "other"]],
                setup: function(a) {
